export declare const HotkeyModifier: {
    readonly CTRL: number;
    readonly ALT: number;
    readonly SHIFT: number;
    readonly META: number;
};
export declare const HotkeyCode: {
    readonly Y: 89;
    readonly Z: 90;
};
/**
 ...
 */
export declare function isHotkey(event: KeyboardEvent, modifiers: (typeof HotkeyModifier)[keyof typeof HotkeyModifier], hotkeyCode: (typeof HotkeyCode)[keyof typeof HotkeyCode]): boolean;
